  ...
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', background: '#ffffff' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 24, padding: '48px 64px 16px' }}>
          <div style={{ width: 72, height: 72, borderRadius: 12, overflow: 'hidden', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ marginTop: 32, marginLeft: 64, marginRight: 64, padding: 24, borderRadius: 20, background: 'linear-gradient(135deg, #eef2ff, #f5f3ff)', border: '1px solid #e2e8f0', display: 'flex', gap: 20 }}>
