...
// Public VAPID key (fallback for runtime), will be overridden by env if set via separate implementation later
const FALLBACK_PUBLIC = 'BI7-mGiNtz_96OIcs4wAaTbh_SwNw9dEI2o2Ih-42IkRn5kBPYajrn2uES7d1jI2tulFJZQKhXGpVIuzSXUflec'

export async function GET() {
  const key = (process.env.NEXT_PUBLIC_VAPID_PUBLIC_KEY || '').trim() || FALLBACK_PUBLIC
>>>>>>> 60e36e8 (feat(push): expose public VAPID key at /api/push/public-key (fallback included))
