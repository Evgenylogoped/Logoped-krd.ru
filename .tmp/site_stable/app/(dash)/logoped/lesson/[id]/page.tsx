  ...
  return (
    <div className="container space-y-6 py-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/logoped/schedule" className="btn">Назад к расписанию</Link>
      </div>
            ...
            <>
              <div className="grid sm:grid-cols-2 gap-2">
                <label className="flex items-center gap-2">
                  <input type="radio" name="paymentMethod" value="AUTO" defaultChecked disabled={isLocked} />
                  <span className="text-sm">Auto (абонемент, если есть)</span>
                </label>
                <label className="flex items-center gap-2">
