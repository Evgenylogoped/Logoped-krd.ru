...
export default async function BranchFinanceEntry() {
  ...
  // Если у пользователя есть права руководителя/бухгалтера — сразу перекидываем в статистику
  if (role === 'ADMIN' || role === 'SUPER_ADMIN' || role === 'ACCOUNTANT' || isOwner || isBranchManager) {
